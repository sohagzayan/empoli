"use client"
import { registerValidationAsCandidateSchema, registerValidationAsRecruiterSchema } from '@/utils/validation-schemas';
    ...
    return (
        <div >
            <div className='bg-white w-[600px] mx-auto p-10 shadow-shadow_dark rounded-[30px] my-4 relative z-50'>
                <Formik
                    initialValues={{ email: '', firstName: '', lastName: '', password: '', cpassword: '' }}

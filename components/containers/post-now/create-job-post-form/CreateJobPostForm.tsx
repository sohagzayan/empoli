...
const CreateJobPostForm = () => {
  ...
  return (
    <div className="container lg:px-16 xl:px-20">
      <div className="mx-auto w-[850px] py-10">
        <h3 className="text-blue-midnight_blue mb-2 text-3xl text-[32px] font-medium md:text-5xl">
                ...
                <div className="">
                  ...
                  <div className="mb-5">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="peer/input text-foreground focus-visible:border-foreground-muted focus-visible:ring-background-control placeholder-foreground-muted bg-destructive-200 border-destructive-500 focus:ring-destructive-400 placeholder:text-destructive-400 group box-border block w-full rounded-md border px-4 py-2 text-sm shadow-sm outline-none transition-all focus:ring-2 focus-visible:shadow-md"
                    >
                      <option selected value="">
                        Experience
                      </option>

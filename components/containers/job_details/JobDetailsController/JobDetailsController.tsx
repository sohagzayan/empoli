            ...
            <div>
                <div className='flex items-center gap-5'>
                    <Button
                        ...
                        className='bg-primary w-full cursor-pointer' >Apply For Job</Button>
                    <Button className='bg-white border-primary border cursor-pointer text-purple hover:text-white'><BookOpen /></Button>
                </div>

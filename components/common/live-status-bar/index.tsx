    ...
    <div className="flex items-center justify-center">
      ...
      >
        ...
        <div className="bg-[rgba(255,255,255,0.12)] px-4 py-3">
          <h2 className="text-lg font-600 text-white">
            Job Portal Live Status
          </h2>
        </div>
        ...
        <div className="px-4 py-6">
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-400">
              Total Job Posts: <span className="text-white">{totalJobs}</span>
            </p>
          </div>
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-400">
              Total Applicants Today:{' '}
              <span className="text-white">{totalApplicants}</span>
            </p>
          </div>
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-400">
              Website Rating:{' '}
              <span className="text-yellow-400">⭐ {averageRating}</span> / 5
            </p>
          </div>
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-400">
              Support Status:{' '}
              <span
                className={`text-${supportStatus === 'Online' ? 'green' : 'red'}-400`}
              >
                {supportStatus}
              </span>
            </p>
